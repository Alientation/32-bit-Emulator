...
TEST_F (EmulatorFixture, ldr_offset_positive_constant)
{
    ...
    // ldr x0, [x1, #3]
    cpu->system_bus->write_word (0, Emulator32bit::asm_format_m (Emulator32bit::_op_ldr, false, 0,
...
TEST_F (EmulatorFixture, ldr_offset_negative_constant)
{
    ...
    cpu->system_bus->write_word (0,
                                 Emulator32bit::asm_format_m (Emulator32bit::_op_ldr, false, 0, 1,
                                                              -3, Emulator32bit::ADDR_OFFSET));
    cpu->set_pc (0);
    cpu->write_reg (1, kPageSize + 3);
    cpu->set_NZCV (0, 0, 0, 0);
...
TEST_F (EmulatorFixture, ldr_offset_reg)
{
    ...
    // ldr x0, [x1, x2]
    cpu->system_bus->write_word (0, Emulator32bit::asm_format_m (Emulator32bit::_op_ldr, false, 0,
                                                                 1, 2, Emulator32bit::SHIFT_LSL, 0,
                                                                 Emulator32bit::ADDR_OFFSET));
    cpu->set_pc (0);
    cpu->write_reg (1, kPageSize - 3);
    cpu->write_reg (2, 3);
    cpu->set_NZCV (0, 0, 0, 0);
