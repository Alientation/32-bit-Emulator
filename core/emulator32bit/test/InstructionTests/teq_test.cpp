...
TEST(teq, register_and_register) {
	...
	// x1: 0b0011
	// x2: 0b1010
	cpu->system_bus.writeWord(0, Emulator32bit::asm_format_o(Emulator32bit::_op_teq, false, 0, 1, 2, 0, 0));
	cpu->_pc = 0;
	cpu->_x[1] = 0b0011;
	cpu->_x[2] = 0b1010;
...
TEST(teq, negative_flag) {
	...
	// x1: (1<<31) - 1
	// x2: ~0
	cpu->system_bus.writeWord(0, Emulator32bit::asm_format_o(Emulator32bit::_op_teq, true, 0, 1, 2, 0, 0));
	cpu->_pc = 0;
	cpu->_x[1] = (1U<<31)-1;
	cpu->_x[2] = ~0;
