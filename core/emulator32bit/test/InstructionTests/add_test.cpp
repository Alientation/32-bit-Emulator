...
TEST(add, register_add_register) {
	...
	// x1: 1
	// x2: 10
	cpu->system_bus.write_word(0, Emulator32bit::asm_format_o(Emulator32bit::_op_add, false, 0, 1, 2, 0, 0));
	cpu->_pc = 0;
	cpu->_x[1] = 1;
	cpu->_x[2] = 10;
...
TEST(add, register_add_register_shifted) {
	...
	// x1: 1
	// x2: 2
	cpu->system_bus.write_word(0, Emulator32bit::asm_format_o(Emulator32bit::_op_add, false, 0, 1, 2, LSL, 3));
	cpu->_pc = 0;
	cpu->_x[1] = 1;
	cpu->_x[2] = 2;
...
TEST(add, negative_flag) {
	...
	// x1: -2
	// x2: 1
	cpu->system_bus.write_word(0, Emulator32bit::asm_format_o(Emulator32bit::_op_add, true, 0, 1, 2, 0, 0));
	cpu->_pc = 0;
	cpu->_x[1] = -2;
	cpu->_x[2] = 1;
