...
TEST(add, register_add_immediate) {
	...
	// add x0, x1, #10
	// x1: 1
	cpu->system_bus.writeWord(0, Emulator32bit::asm_format_o(Emulator32bit::_op_add, false, 0, 1, 10));
	cpu->_pc = 0;
	cpu->_x[1] = 1;
...
TEST(add, register_add_register) {
	...
	// x1: 1
	// x2: 10
	cpu->system_bus.writeWord(0, Emulator32bit::asm_format_o(Emulator32bit::_op_add, false, 0, 1, 2, 0, 0));
	cpu->_pc = 0;
	cpu->_x[1] = 1;
	cpu->_x[2] = 10;
...
TEST(add, negative_flag) {
	...
	// x1: -2
	// x2: 1
	cpu->system_bus.writeWord(0, Emulator32bit::asm_format_o(Emulator32bit::_op_add, true, 0, 1, 2, 0, 0));
	cpu->_pc = 0;
	cpu->_x[1] = -2;
	cpu->_x[2] = 1;
