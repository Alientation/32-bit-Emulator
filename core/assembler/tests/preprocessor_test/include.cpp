...
TEST_F (EmulatorFixture, include_local_dir)
{
    Process p ("-kp " + AEMU_PROJECT_ROOT_DIR
               + "core/assembler/tests/preprocessor_test/src/include_local_dir.basm "
                 "-outdir "
...
{
    Process p ("-kp " + AEMU_PROJECT_ROOT_DIR
               + "core/assembler/tests/preprocessor_test/src/include_sys_dir.basm " + "-I "
               + AEMU_PROJECT_ROOT_DIR + "core/assembler/tests/preprocessor_test/include/system "
