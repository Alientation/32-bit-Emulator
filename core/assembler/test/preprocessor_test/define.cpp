...
TEST_F (EmulatorFixture, define_no_args)
{
    Process p ("-kp " + AEMU_PROJECT_ROOT_DIR +
            "core/assembler/test/preprocessor_test/src/define_no_args.basm "
...
{
    Process p ("-kp " + AEMU_PROJECT_ROOT_DIR +
            "core/assembler/test/preprocessor_test/src/define_no_args_multiline.basm "
            "-outdir " + AEMU_PROJECT_ROOT_DIR +
            "core/assembler/test/preprocessor_test/build");
    ASSERT_TRUE (p.does_create_exe ());
...
{
    Process p ("-kp " + AEMU_PROJECT_ROOT_DIR +
            "core/assembler/test/preprocessor_test/src/define_args.basm "
            "-outdir " + AEMU_PROJECT_ROOT_DIR +
            "core/assembler/test/preprocessor_test/build");
    ASSERT_TRUE (p.does_create_exe ());
...
{
    Process p ("-kp " + AEMU_PROJECT_ROOT_DIR +
            "core/assembler/test/preprocessor_test/src/define_args_multiline.basm "
            "-outdir " + AEMU_PROJECT_ROOT_DIR +
            "core/assembler/test/preprocessor_test/build");
    ASSERT_TRUE (p.does_create_exe ());
...
{
    Process p ("-kp " + AEMU_PROJECT_ROOT_DIR +
            "core/assembler/test/preprocessor_test/src/define_redefine.basm "
            "-outdir " + AEMU_PROJECT_ROOT_DIR +
            "core/assembler/test/preprocessor_test/build");
    ASSERT_TRUE (p.does_create_exe ());
...
{
    Process p ("-kp " + AEMU_PROJECT_ROOT_DIR +
            "core/assembler/test/preprocessor_test/src/define_undefine.basm "
            "-outdir " + AEMU_PROJECT_ROOT_DIR +
            "core/assembler/test/preprocessor_test/build");
    ASSERT_TRUE (p.does_create_exe ());
