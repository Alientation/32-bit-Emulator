...
const std::unordered_map<Tokenizer::Type,std::string> Tokenizer::VARIABLE_TYPE_TO_NAME_MAP = {
...
const std::set<Tokenizer::Type> Tokenizer::VARIABLE_TYPES = {
...
const std::vector<std::pair<std::string, Tokenizer::Type>> Tokenizer::TOKEN_SPEC = {
	{":lo12:", RELOCATION_EMU32_O_LO12}, {":hi20:", RELOCATION_EMU32_ADRP_HI20},
	{":lo19:", RELOCATION_EMU32_MOV_LO19}, {":hi13:", RELOCATION_EMU32_MOV_HI13},
