...
std::vector<Tokenizer::Token> Tokenizer::tokenize(std::string source_code, bool keep_comments)
{
    ...
    std::unordered_map<std::string, Type> simple_map =
    {
        ...
        {"hlt", INSTRUCTION_HLT}, {"nop", INSTRUCTION_NOP},
        ...
        {"msr", INSTRUCTION_MSR}, {"mrs", INSTRUCTION_MRS}, {"tlbi", INSTRUCTION_TLBI},
        {"ldadd", INSTRUCTION_LDADD}, {"ldaddb", INSTRUCTION_LDADDB}, {"ldaddh", INSTRUCTION_LDADDH},
        {"ldclr", INSTRUCTION_LDCLR}, {"ldclrb", INSTRUCTION_LDCLRB}, {"ldclrh", INSTRUCTION_LDCLRH},
        {"ldset", INSTRUCTION_LDSET}, {"ldsetb", INSTRUCTION_LDSETB}, {"ldseth", INSTRUCTION_LDSETH},
...
const std::unordered_map<Tokenizer::Type, std::string> Tokenizer::TYPE_TO_NAME_MAP =
{
    ...
    {INSTRUCTION_HLT, "INSTRUCTION_HLT"}, {INSTRUCTION_NOP, "INSTRUCTION_NOP"},
    ...
    {INSTRUCTION_MSR, "INSTRUCTION_MSR"}, {INSTRUCTION_MRS, "INSTRUCTION_MRS"}, {INSTRUCTION_TLBI, "INSTRUCTION_TLBI"},
    {INSTRUCTION_LDADD, "INSTRUCTION_LDADD"}, {INSTRUCTION_LDADDB, "INSTRUCTION_LDADDB"}, {INSTRUCTION_LDADDH, "INSTRUCTION_LDADDH"},
    {INSTRUCTION_LDCLR, "INSTRUCTION_LDCLR"}, {INSTRUCTION_LDCLRB, "INSTRUCTION_LDCLRB"}, {INSTRUCTION_LDCLRH, "INSTRUCTION_LDCLRH"},
    {INSTRUCTION_LDSET, "INSTRUCTION_LDSET"}, {INSTRUCTION_LDSETB, "INSTRUCTION_LDSETB"}, {INSTRUCTION_LDSETH, "INSTRUCTION_LDSETH"},
