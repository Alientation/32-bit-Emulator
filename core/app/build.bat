...
cmake -S ../emulator32bit -B ../emulator32bit/build -G Ninja -DCMAKE_INSTALL_PREFIX="../emulator32bit/install"
...
cmake -S . -B build/release -G Ninja -DCMAKE_BUILD_TYPE=RelWithDebInfo -DCMAKE_PREFIX_PATH="../assembler/install;../emulator32bit/install;../util/install"
