...
class AlienCPU {
    ...
    private: 
        ...
        u16 ADDRESSING_MODE_ABSOLUTE_INDEXED_GETVALUE_TWOBYTES(u16 indexRegister);
        u16 ADDRESSING_MODE_XINDEXED_INDIRECT_GETVALUE_TWOBYTES();
        u16 ADDRESSING_MODE_INDIRECT_YINDEXED_GETVALUE_TWOBYTES();
        u16 ADDRESSING_MODE_ZERO_PAGE_GETVALUE_TWOBYTES();
        u16 ADDRESSING_MODE_ZERO_PAGE_INDEXED_GETVALUE_TWOBYTES(u16 indexRegister);
