...
class AlienCPU {
    ...
    private: 
        ...
        u16 ADDRESSING_IMMEDIATE_READ_TWOBYTES();
        u16 ADDRESSING_ABSOLUTE_READ_TWOBYTES();
        u16 ADDRESSING_ABSOLUTE_INDEXED_READ_TWOBYTES(u16 indexRegister);
        u16 ADDRESSING_XINDEXED_INDIRECT_READ_TWOBYTES();
        u16 ADDRESSING_INDIRECT_YINDEXED_READ_TWOBYTES();
        u16 ADDRESSING_ZEROPAGE_READ_TWOBYTES();
        ...
        void ADDRESSING_XINDEXED_INDIRECT_WRITE_TWOBYTES(u16 registerValue);
        void ADDRESSING_INDIRECT_YINDEXED_WRITE_TWOBYTES(u16 registerValue);
