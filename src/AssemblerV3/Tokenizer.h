...
class Tokenizer {
    public:
        ...
        inline static const std::vector<std::pair<std::string, Type>> TOKEN_SPEC = {
            ...
            {"^#ifequ(?=\\s)", PREPROCESSOR_IFEQU},
            {"^#ifnequ(?=\\s)", PREPROCESSOR_IFNEQU},
            {"^#ifless(?=\\s)", PREPROCESSOR_IFLESS},
            {"^#ifmore(?=\\s)", PREPROCESSOR_IFMORE},
			{"^#else(?=\\s)", PREPROCESSOR_ELSE},
			{"^#elsedef(?=\\s)", PREPROCESSOR_ELSEDEF},
			{"^#elsendef(?=\\s)", PREPROCESSOR_ELSENDEF},
            {"^#elseequ(?=\\s)", PREPROCESSOR_ELSEEQU},
            {"^#elsenequ(?=\\s)", PREPROCESSOR_ELSENEQU},
            {"^#elseless(?=\\s)", PREPROCESSOR_ELSELESS},
            {"^#elsemore(?=\\s)", PREPROCESSOR_ELSEMORE},
