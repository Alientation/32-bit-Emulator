...
void Assembler::DIR_GLOBAL() {
	...
	std::string globalLabel = tokens[currentTokenI].string;
	if (globalLabel.size() == 0) {
		error(INVALID_TOKEN_ERROR, tokens[currentTokenI], std::stringstream() 
				<< "Invalid label name for .global directive: " << globalLabel);
	}

	// check if the label has already been defined as global
	if (globalLabels.find(globalLabel) != globalLabels.end()) {
		error(INVALID_TOKEN_ERROR, tokens[currentTokenI], std::stringstream() 
				<< "Label already defined for .global directive: " << globalLabel);
	}

	// current scope must be the global scope
	if (currentScope != globalScope) {
		error(INVALID_TOKEN_ERROR, tokens[currentTokenI], std::stringstream() 
				<< "Cannot define global label in non-global scope: " << globalLabel);
	}

	globalLabels.insert(globalLabel);
	parsedTokens.push_back(ParsedToken(tokens[currentTokenI], TOKEN_DIRECTIVE_OPERAND));

	defineLabel(globalLabel, currentProgramCounter);
}
...
void Assembler::DIR_ASSERT() {

}

void Assembler::DIR_ERROR() {

}

void Assembler::DIR_ERRORIF() {

}

void Assembler::DIR_IF() {

}

void Assembler::DIR_IFDEF() {

}

void Assembler::DIR_IFNDEF() {

}

void Assembler::DIR_ELSEIF() {

}

void Assembler::DIR_ELSEIFDEF() {

}

void Assembler::DIR_ELSEIFNDEF() {

}

void Assembler::DIR_ELSE() {

}

void Assembler::DIR_ENDIF() {

}

void Assembler::DIR_PRINT() {

}

void Assembler::DIR_PRINTIF() {

}

void Assembler::DIR_PRINTNOW() {
